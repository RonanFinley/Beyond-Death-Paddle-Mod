...
# Beyond Death
# Weapon Update
#Note: Repl.it doesn't like pasting long strings for loading saves. Saving simply won't work on repl.it

# Paddle mod
# Adds paddles
# Used as weapons.
# Craft with a Dark Shard and Wood
...
if(len(variableify(tutorial)) > 0 and variableify(tutorial)[0] == "Y"):
    ...
    while(input("I ") != "craft"):
        ...
        print("I craft")
    print("")
    print("Remember, we want to craft a 'Leaf' and a 'String'")
...
def masscraft(a,b):
    ...
    docraft(a,b,"Leather",1,"String",1,"Makeshift Basket",1,0.3)
    ...
    docraft(a,b,"Wood",1,"Leather",1,"Wooden Armor",1,0.2)
    docraft(a,b,"Wood",1,"Cloth",1,"Makeshift Spear",1,0.3)
    docraft(a,b,"Wood",1,"Iron Bar",1,"Iron Spear",1,0.3)
    docraft(a,b,"Wood",1,"Stick",1,"Wooden Club",1,0.2)
    docraft(a,b,"Stick",1,"String",1,"Fishing Rod",1,0.2)
    docraft(a,b,"Leaf",1,"String",1,"Cloth",2,0.2)
    ...
    docraft(a,b,"Leaf",1,"Cloth",1,"Tinder",1,0.2)
    ...
    docraft(a,b,"Grass",1,"Leaf",1,"String",5,0.1)
    docraft(a,b,"Chain",1,"Iron Bar",1,"Chainmail",1,0.1)
    docraft(a,b,"Chainmail",1,"Iron Bar",1,"Knight Armor",1,0.1)
    docraft(a,b,"Wood",1,"Leaf",100,"Raft",1,0.1)
    docraft(a,b,"Iron Bar",1,"Stick",1,"Pickaxe",1,0.1)
    docraft(a,b,"Leaf",1,"Flower",1,"Bandage",1,0.1)
    ...
    docraft(a,b,"Stick",1,"Leaf",1,"Arrow",1,0.2)
    ...
    docraft(a,b,"Cloth",1,"Grass",1,"Paper",1,0.1)
    ...
    #Guns
    docraft(a,b,"Plasma Crystal",1,"Plasma Charge",1,"Plasma Charge",10,0.3)
    docraft(a,b,"Plasma Crystal",1,"XP",1,"Plasma Charge",10,0.5)
    docraft(a,b,"Plasma Crystal",1,"Grenade",1,"Plasma Grenade",5,0.2)
    docraft(a,b,"Plasma Crystal",1,"Pistol",1,"Plasma Pistol",5,0.2)
    docraft(a,b,"Plasma Crystal",1,"Rifle",1,"Plasma Rifle",5,0.2)
    docraft(a,b,"Plasma Crystal",1,"Missle Launcher",1,"Plasma Cannon",5,0.2)
    docraft(a,b,"Plasma Crystal",1,"Double Barrel Shotgun",1,"Plasma Shotgun",5,0.2)
    docraft(a,b,"Plasma Crystal",1,"Combat Shotgun",1,"Plasma Shotgun",5,0.2)
    docraft(a,b,"Plasma Crystal",1,"Iron Sword",1,"Plasma Sword",5,0.2)
    docraft(a,b,"Dark Shard",1,"Pistol",1,"Blood Pistol",5,0.2)
    docraft(a,b,"Dark Shard",1,"Rifle",1,"Blood Rifle",5,0.2)
    docraft(a,b,"Dark Shard",1,"Grenade",1,"Blood Grenade",5,0.2)
    docraft(a,b,"Dark Shard",1,"Double Barrel Shotgun",1,"Blood Shotgun",5,0.2)
    docraft(a,b,"Dark Shard",1,"Combat Shotgun",1,"Blood Shotgun",1,0.2)
    docraft(a,b,"Dark Shard",1,"Iron Sword",1,"Blood Sword",5,0.2)
    ...
    docraft(a,b,"String",1,"Cloth",1,"Rope",1,0.1)

    # mod
    docraft(a,b,"Dark Shard",1,"Wood",1,"Paddle",1,0.0)
...
def addwound(wounds):
  ...
  if(finditem("Field")!=-1 and inventory[finditem("Field")][1]>=1):
    ...
    if(hits>=inventory[finditem("Field")][1]):
        ...
        hits=0
    if(field > 1):
        print("Your forcefield absorbed "+int_to_en(dodges)+" attacks")
    elif(field == 1):
...
def chestlootable():
    ...
    lootable(0.01,"Pistol",0)
    lootable(0.005,"Rifle",0)
    lootable(0.005,"Blood Pistol",0)
    lootable(0.005,"Blood Rifle",0)
    lootable(0.005,"Blood Sword",0)
    lootable(0.005,"Plasma Sword",0)
    lootable(0.001,"Field Generator",0)
    lootable(0.0005,"Machine Gun",0)
    lootable(0.0001,"Minigun",0)
    lootable(0.005,"Plasma Pistol",0)
    lootable(0.001,"Plasma Rifle",0)
    lootable(0.001,"Plasma Shotgun",0)
    lootable(0.0005,"Plasma Cannon",0)
    lootable(0.0005,"Missle Launcher",0)
    lootable(0.001,"Missle",2)
    lootable(0.01,"Grenade",2)
    lootable(0.005,"Fragmentation Grenade",2)
    lootable(0.005,"Napalm Grenade",2)
    lootable(0.001,"Plasma Grenade",2)
    lootable(0.001,"Blood Grenade",2)
    lootable(0.001,"Magic Grenade",2)
    lootable(0.005,"Plasma Crystal",0)
    lootable(0.01,"Plasma Charge",2)
    lootable(0.005,"Double Barrel Shotgun",0)
    lootable(0.001,"Combat Shotgun",0)
    lootable(0.001,"Chain Shotgun",0)
    ...
    lootable(0.0001,"Death Amulet",0)
    lootable(0.0001,"Anticurse Scroll",0)
    lootable(0.0001,"Fire Scroll",0)
    lootable(0.0001,"Strike Scroll",0)
    lootable(0.0001,"Food Scroll",0)
    lootable(0.0001,"Water Scroll",0)
    lootable(0.0001,"Plant Scroll",0)
    lootable(0.0001,"Healing Scroll",0)
    lootable(0.0001,"Wealth Scroll",0)
    lootable(0.0001,"Binding Scroll",0)
    lootable(0.0001,"Blank Scroll",0)
    lootable(0.0001,"Strike Scroll",0)
            ...
            if(useitem=="NVM" or useitem=="LEG" or useitem=="LEGS" or useitem=="FLEE"):
              ...
              cancercheck()
               ...
               if(finditem("Healing Boon") != -1 and inventory[finditem("Healing Boon")][1] > 0):
                ...
                hp=hp-(int((random.random()*10)/modifier))-1
                ...
                if(finditem("Shotgun Shell")!=-1 and inventory[finditem("Shotgun Shell")][1]>0):
                    damdone = 8-(int(random.random()*modifier*0.2))
                    if(damdone < 2):
                        damedone = 1
                    hp=hp-damdone
                    print("You do "+damdone+" damage")
                ...
                if(finditem("Shotgun Shell")!=-1 and inventory[finditem("Shotgun Shell")][1]>0):
                    damdone = 6-(int(random.random()*modifier*0.3))
                    if(damdone < 2):
                        damedone = 2
                    hp=hp-damdone
                    print("You do "+damdone+" damage")
                ...
                if(finditem("Shotgun Shell")!=-1 and inventory[finditem("Shotgun Shell")][1]>0):
                    ...
                    if(damdone < item):
                        damdone = item
                    hp=hp-damdone
                    print("You do "+str(damdone)+" damage, using "+str(item)+" shells")
                    addstuff("Shotgun Shell",-item)
                    ammoboon("Shotgun Shell")
                ...
                hp=hp-(5+int(random.random()*12))
                print("")
                print("wack")
                print("")
                breakable("Paddle",0.1)
                ...
                print("You throw the bottle, lighting them on fire for 5 turns")
...
def identify (item):
    ...
    if(finditem("curse of insanity") != -1 and random.random()<0.1*inventory[finditem("curse of insanity")][1]*modifier):
        ...
        if(item=="t"):
            ...
            return("unknown")
print()
def shopDesection(item):
  items = item.split(", ")
  return [items[0][1:len(items[0])-1],int(items[1]),int(items[2])]
def shopDestring(item):
  item=item.replace("],[","], [")
  if(len(item) <= 2):
    return []
  ...
  for i in range(len(items)):
    temp.append(shopDesection(items[i]))
  return temp
def inventoryDesection(item):
  items = item.split(", ")
  if(items[0][1:len(items[0])-1] != "Water" and items[0][1:len(items[0])-1] != "Food"):
      return [items[0][1:len(items[0])-1],int(items[1])]
  else:
      return [items[0][1:len(items[0])-1],float(items[1])]
def inventoryDestring(item):
  item=item.replace("],[","], [")
  if(len(item) <= 2):
    return []
  item = item[2:len(item)-2]
  ...
  temp=[]
  for i in range(len(items)):
    temp.append(inventoryDesection(items[i]))
  return temp
def mapDestring(item):
  item=item.replace("],[","], [")
  item = item[2:len(item)-2]
  items = item.split("], [")
  temp=[]
  for i in range(len(items)):
    item.replace("','","', '")
    temp.append(items[i][1:len(items[i])-1].split("', '"))
  return temp
while(alive==1):
    ...
    if(a=="LOOK"):
       ...
       if(b!="x"):
           ...
           if((world[origx][origy] == 'w' or world[origx][origy] == '~') and (world[x][y] == 'w' or world[x][y] == '~') and (finditem("Raft")!=-1 and (inventory[finditem("Raft")][1] > 0))):
        ...
        if(b=="ACOMMAND"):
            ...
            print("This command draws a map of the region, w's and ~ represent water and t's represent trees. There are other symbols, but those are for you to learn about")
        elif(b=="OBSERVE"):
       ...
       print("",end="_SV_")
       print(modifier,end="_SV_")
       print(x,end="_SV_")
       print(y,end="_SV_")
       print(totalhours,end="_SV_")
       print(shopfeel,end="_SV_")
       print(shop,end="_SV_")
       print(possibleshop,end="_SV_")
       print(world,end="_SV_")
       print(inventory,end="_SV_")
    elif(a=="LOAD"):
      print("Paste the save data. Be sure to have no extra charecters")
      savedata=input()
      ...
      savedata=savedata[savedata.find("_SV_")+4 : len(savedata)]
      shop=shopDestring(savedata[0:savedata.find("_SV_")])
      savedata=savedata[savedata.find("_SV_")+4 : len(savedata)]
      possibleshop=shopDestring(savedata[0:savedata.find("_SV_")])
      savedata=savedata[savedata.find("_SV_")+4 : len(savedata)]
      world=mapDestring(savedata[0:savedata.find("_SV_")])
      savedata=savedata[savedata.find("_SV_")+4 : len(savedata)]
      inventory=inventoryDestring(savedata)
           ...
           if(useitem=="HANDS" or useitem=="BASICGLOVES" or useitem=="CLOTHGLOVES" or useitem=="HIDEGLOVES" or useitem=="LEATHERGLOVES" or useitem=="CHAINGLOVES"  or useitem=="IRONGLOVES"):
              ...
              cancercheck()
               ...
               if(world[x][y]=="w" or world[x][y]=="~"):
                   print("You hit the water with a paddle. It doesn't do much.")
               else:
                   print("You hit the ground with a paddle. It doesn't do much.")
               print("Perhaps it might make a good weapon?")
           elif(useitem=="MAKESHIFTAXE"):
               if(world[x][y]=="t" or world[x][y]=="T"):
                   odds=random.random()
                   if(finditem("Unbreaking Boon")!=-1 and (1+(inventory[finditem("Unbreaking Boon")][1]/4)) > 0):
                ...
                if(world[x][y]=="x" or world[x][y]=="X"):
                   ...
                   if(variableify(cut)[0]=="Y"):
                       ...
                       if(random.random()*modifier>0.5*favor):
                           ...
                           if(finditem("paddle")!=-1 and inventory[finditem("paddle")][1]>=1):
                               print("The devil looks at you closely.")
                               print("\"You have a paddle, I see.\" he says")
                               print("The devil inspects your eyes for a moment.")
                               print("He stands up. \"A weapon for legends.\"")
                               print("\"Have another!\"")
                               print("Another paddle is added to your inventory")
                               addstuff("Paddle",1)
                   else:
             ...
             if(world[x][y]=="|"):
               ...
               print("17) 15xp Spear Boon. Spears have a small chance to do double damage")
               print("18) 15xp New Map. Simply regens the map. Unlike the map item, it does not effect dificulty")
               print("19) 50xp Difficulty Decrease. The game gets marginally easier")
               print("20) 25xp Difficulty Increase. The game gets marginally harder")
               print("21) 10xp Loot kits. You get a loot kit. Thats all")
               print("22) 10xp Coins. You get some Coins. Thats all")
               print("23) 15xp Cure cancer. When bought, cancer is removed. No fuss, just gone")
               print("24) 15xp Cure radiation. When bought, radiation is removed. No fuss, just gone")
               print("25) 15xp Cure infections. When bought, infections are removed. No fuss, just gone")
               print("26) 15xp Cure wounds. When bought, all wounds are removed. No fuss, just gone")
               print("27) 20xp Curse Removal. When bought, one curse is removed. No fuss, just gone")
               invalid=-1
               while(invalid==1 or invalid==-1):
                    if(invalid==1):
                        print("That is not valid")
...
if(totalhours*modifier > 4000):
  print("You were the most powerfull god of all time. Noone ever has, nor ever will supass you")
if(totalhours*modifier > 3900):
  print("You were the most powerfull god of all time")
if(totalhours*modifier > 3800):
  print("You were the most powerfull god, almost of all time")
if(totalhours*modifier > 3700):
  print("You were the most powerfull god")
if(totalhours*modifier > 3600):
  print("You were practically the most powerfull god")
if(totalhours*modifier > 3500):
  print("You were almost practically the most powerfull god")
if(totalhours*modifier > 3400):
  print("You were one of the most powerfull gods")
if(totalhours*modifier > 3300):
  print("You were, almost, one of the most powerfull gods")
if(totalhours*modifier > 3200):
  print("You were an incredibly powerfull god")
if(totalhours*modifier > 3200):
  print("You were a powerfull god")
